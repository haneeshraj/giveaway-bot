      ...
      if (
        ...
        if (args[0] === "help") {
          const setEmbed = new EmbedBuilder()
            ...
            .setDescription(
              "A feature used to create a giveaway event and pick a random user. The winner is pick if he entered the event by reacting to the event.\n"
            )
            .setFields(
              { name: "help", value: "```js\n>giveaway help```" },
              {
                name: "create",
                value:
                  "```js\n>giveaway create [days] [hours] [minutes] [seconds] title: [title-content] desc: [description-content]```",
              },
              {
                name: "example",
                value:
                  "```js\n>giveaway create 1 2 45 0 title: Example Title desc: Example Description```",
              }
            );
